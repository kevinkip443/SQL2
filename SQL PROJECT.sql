...
--SQL PRACTICAL QUESTIONS WITH ANSWERS.
--USE THE DATBASE BELOW TO ANSWER THE QUESTIONS
...
--QUESTION ONE.Find the total amount spent bty each customer in ZOMATO company.
...
select userid, count( distinct created_date) as 'number of visit'
from sales
group by userid
...
-- QUESTION FOUR
--What's the most purchased item in the menu and at what amounts?
--first parts
